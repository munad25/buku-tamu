...
//apabila user yang mengakses sah
	...
	<body>
	<table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor=" 	 	 	 	#FF99CC">
		<tr>
	...
	<tr>
		<td width="200" valign="top" bgcolor="#FFCCFF" id="menu">
		<?php include "menu.php"; ?>
		</td>
   		<td align="left" valign="top" bgcolor="#FF99FF" class="text" id="content"><?php include "konten.php"; ?></td>
    </tr>
    <tr>
